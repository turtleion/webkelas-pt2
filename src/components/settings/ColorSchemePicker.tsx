...
export function ColorSchemePicker() {
  ...
  const [showCustom, setShowCustom] = useState(
    Boolean(preferences.customColors),
  );
  const [activeGroup, setActiveGroup] = useState<
    "brand" | "surface" | "nav" | "advanced"
  >("brand");

  const currentMode = preferences.mode;
  const activeScheme =
    COLOR_SCHEMES[preferences.colorScheme] || COLOR_SCHEMES.paper;
  const activePalette =
    currentMode === "dark" && activeScheme.dark
      ? activeScheme.dark
      : activeScheme.light;
  ...
  const handleColorChange = async (
    tokenKey: keyof ColorPaletteTokens,
    hex: string,
  ) => {
    const updated = {
  ...
  const getEffectiveColor = (token: keyof ColorPaletteTokens): string => {
    return (
      (customModeColors[token] as string) ||
      (activePalette[token] as string) ||
      "#000000"
    );
  };
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-[13px] text-muted-foreground">
          Pilih skema palet bawaan atau sesuaikan peran warna semantik (Primary,
          Surface, Nav, dll).
        </p>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {Object.values(COLOR_SCHEMES).map((scheme) => {
          ...
          const p =
            currentMode === "dark" && scheme.dark ? scheme.dark : scheme.light;
      ...
      <div className="border border-border/80 rounded-md bg-card/40 overflow-hidden">
        ...
        >
          <span>
            ...
            {currentMode === "dark" ? t.colors.darkMode : t.colors.lightMode})
          </span>
          {showCustom ? (
        ...
        {showCustom && (
          <div className="border-t border-border/60 p-4 space-y-4">
            <p className="font-mono text-[11px] text-muted-foreground">
              Menyesuaikan peran warna semantik di bawah ini otomatis
              menyinkronkan live preview dan mengaktifkan status Tema Kustom.
            </p>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-2">
                ...
                <div className="rounded border border-border/70 p-3 bg-background/40 space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    {hasContrastWarning(
                      getEffectiveColor("primary"),
                      getEffectiveColor("primaryForeground"),
                    ) && (
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="kicker block text-[9px] mb-1">
                        {t.colors.primary}
                      </label>
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            void handleColorChange("primary", e.target.value)
                          }
                ...
                <div className="rounded border border-border/70 p-3 bg-background/40 space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    {hasContrastWarning(
                      getEffectiveColor("accent"),
                      getEffectiveColor("accentForeground"),
                    ) && (
                      <span className="flex items-center gap-1 text-[10px] text-amber-600 dark:text-amber-400 font-mono">
                        <AlertCircle className="size-3" /> Kontras rendah
                      </span>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            void handleColorChange("accent", e.target.value)
                          }
                          className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                        />
                        <input
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-2">
                ...
                <div className="rounded border border-border/70 p-3 bg-background/40 space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    {hasContrastWarning(
                      getEffectiveColor("background"),
                      getEffectiveColor("foreground"),
                    ) && (
                      <span className="flex items-center gap-1 text-[10px] text-amber-600 dark:text-amber-400 font-mono">
                        <AlertCircle className="size-3" /> Kontras rendah
                      </span>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            void handleColorChange("background", e.target.value)
                          }
                          className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                        />
                        <input
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            void handleColorChange("foreground", e.target.value)
                          }
                          className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                        />
                        <input
                ...
                <div className="rounded border border-border/70 p-3 bg-background/40 space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="font-display text-xs font-semibold">
                      {t.colors.surfaceGroup}
                    </span>
                    {hasContrastWarning(
                      getEffectiveColor("card"),
                      getEffectiveColor("cardForeground"),
                    ) && (
                      <span className="flex items-center gap-1 text-[10px] text-amber-600 dark:text-amber-400 font-mono">
                        <AlertCircle className="size-3" /> Kontras rendah
                      </span>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            void handleColorChange("card", e.target.value)
                          }
                          className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                        />
                        <input
            ...
            {activeGroup === "nav" && (
              <div className="rounded border border-border/70 p-3 bg-background/40 space-y-2.5 max-w-xl">
                <div className="flex items-center justify-between">
                  ...
                  {hasContrastWarning(
                    getEffectiveColor("nav"),
                    getEffectiveColor("onNav"),
                  ) && (
                    <span className="flex items-center gap-1 text-[10px] text-amber-600 dark:text-amber-400 font-mono">
                      <AlertCircle className="size-3" /> Kontras rendah
                    </span>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      <input
                        ...
                        onChange={(e) =>
                          void handleColorChange("nav", e.target.value)
                        }
                        className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                      />
                      <input
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      <input
                        ...
                        onChange={(e) =>
                          void handleColorChange("onNav", e.target.value)
                        }
                        className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                      />
                      <input
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            void handleColorChange("tertiary", e.target.value)
                          }
                          className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                        />
                        <input
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            void handleColorChange("onTertiary", e.target.value)
                          }
                          className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                        />
                        <input
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      <input
                        ...
                        onChange={(e) =>
                          void handleColorChange("border", e.target.value)
                        }
                        className="size-7 rounded cursor-pointer border border-border bg-transparent p-0"
                      />
                      <input
