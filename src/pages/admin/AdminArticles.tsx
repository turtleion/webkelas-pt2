          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-border/60">
              {data.map((item) => (
                ...
                >
                  <td className="p-3 pl-4 font-display font-medium">
                    {item.title}
                  </td>
                  ...
                  <td className="p-3">
                    <span
                      className={`inline-flex items-center rounded border px-2 py-0.5 font-mono text-[9px] uppercase tracking-wider font-semibold ${item.published ? "bg-accent/20 text-accent border-accent/30" : "bg-muted text-muted-foreground"}`}
                    >
          ...
          <form onSubmit={handleSubmit} className="mt-4 space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (!editingItem) setSlug(slugify(e.target.value));
                }}
            ...
            <div>
              ...
              <Textarea
                ...
                className="mt-1 h-16 bg-background/50 text-sm"
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                className="mt-1 h-32 bg-background/50 text-sm"
                required
              />
            </div>
            <div>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="isPinned" className="text-[13px] cursor-pointer">
                Sematkan artikel ini
              </label>
            </div>
