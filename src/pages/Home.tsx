      ...
      <main id="konten">
          ...
          <div className="border-b border-border/70 bg-card/40">
            <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-2.5 md:px-8">
              <p className="kicker flex min-w-0 items-center gap-2.5 text-[10px]">
                <span className="shrink-0 text-accent">Pengumuman terbaru</span>
                <span aria-hidden className="text-muted-foreground/60">
                  —
                </span>
                <span className="truncate text-muted-foreground">
                  {pengumuman[0]?.title || "Belum ada pengumuman baru"}
                </span>
              </p>
              <Link
                to="/pengumuman"
              ...
              <div className="lg:col-span-7 lg:pr-6">
                <FadeIn>
                  ...
                  <p className="mt-5 max-w-lg font-display text-xl italic leading-snug text-muted-foreground md:text-2xl">
                    Satu kelas, {kelas.jumlahSiswa || anggota.length} orang, dan satu tahun pelajaran
                    — dicatat di sini.
                  </p>

                  <p className="mt-6 max-w-xl text-[15px] leading-relaxed text-foreground/80">
                    Ini ruang digital {kelas.nama}: tempat pengumuman, jadwal,
                    agenda, dan dokumentasi kelas berkumpul. Dibuat oleh siswa
                    untuk siswa, supaya informasi kelas mudah ditemukan dan tidak
                  ...
                  <FadeIn delay={120}>
                    <div className="relative ml-auto max-w-sm md:max-w-md">
                      <PhotoPlate
                        ...
                        caption={galeri[0]?.title || `Foto kelas ${kelas.nama} — MPLS 2026`}
          ...
          <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
            <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
              <div className="lg:col-span-4">
                <SectionHead no="01" label="Profil" title="Identitas kelas" />
                <p className="mt-5 max-w-sm text-[14px] leading-relaxed text-muted-foreground">
                  Fakta dasar kelas {kelas.nama} di tahun ajaran{" "}
                  {kelas.tahunAjaran}. Data dapat diperbarui melalui panel pengurus.
                </p>
              </div>
        ...
        <section className="border-b border-border bg-card/40">
          <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
            <SectionHead
              ...
              title="Wajah kelas"
              linkTo="/anggota"
              linkText={`Semua ${anggota.length} anggota`}
            />
        ...
        <section className="border-b border-border">
          <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-14 md:flex-row md:items-center md:justify-between md:px-8">
            <div>
              <p className="kicker text-[10px]">Punya informasi untuk kelas?</p>
              <p className="mt-2 font-display text-2xl font-medium tracking-tight md:text-3xl">
                Sampaikan ke pengurus kelas — atau lewat sekretaris.
              </p>
            </div>
            <Link
              to="/organisasi"
