...
Cohesion: 0.05
Nodes (122): Orang(), Organisasi(), AdminLayout(), AdminLayoutProps, AdminSidebar(), AdminSidebarProps, ConfirmDialog(), DataTable() (+114 more)

### Community 1 - "ConfirmDialog.tsx"
Cohesion: 0.18
Nodes (15): ConfirmDialogProps, AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription(), AlertDialogFooter(), AlertDialogHeader() (+7 more)
...
Cohesion: 0.08
Nodes (51): BackgroundSelector(), ColorSchemePicker(), getLuminance(), hasContrastWarning(), FontSelector(), LanguageSelector(), LayoutSelector(), LivePreview() (+43 more)
...
Cohesion: 0.05
Nodes (58): Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AspectRatio(), ContextMenu(), ContextMenuCheckboxItem(), ContextMenuContent() (+50 more)

### Community 7 - "cn"
Cohesion: 0.05
Nodes (55): Alert(), AlertDescription(), AlertTitle(), alertVariants, Avatar(), AvatarFallback(), AvatarImage(), ButtonGroup() (+47 more)
...
### Community 9 - "useAuth"
Cohesion: 0.09
Nodes (32): RequireAdmin(), RequireOwner(), AuthStateRedirector(), RequireAuth(), RequireSignedIn(), RequireVerified(), useAuth(), UseAuthReturn (+24 more)
...
### Community 13 - "db.ts"
Cohesion: 0.05
Nodes (81): HomeLayoutProps, HomeLayoutProps, HomeLayoutProps, HomeLayoutProps, HomeLayoutProps, HomeLayoutProps, FadeIn(), PhotoPlate() (+73 more)

### Community 14 - "input-group.tsx"
Cohesion: 0.10
Nodes (20): InputGroup(), InputGroupAddon(), inputGroupAddonVariants, InputGroupButton(), inputGroupButtonVariants, InputGroupInput(), InputGroupText(), InputGroupTextarea() (+12 more)

### Community 15 - "carousel.tsx"
Cohesion: 0.19
Nodes (13): Carousel(), CarouselApi, CarouselContent(), CarouselContext, CarouselContextProps, CarouselItem(), CarouselNext(), CarouselOptions (+5 more)

### Community 16 - "instrumentation.tsx"
Cohesion: 0.18
...
Cohesion: 0.13
Nodes (15): class-variance-authority, dependencies, class-variance-authority, @radix-ui/react-scroll-area, @radix-ui/react-separator, @radix-ui/react-switch, @radix-ui/react-toggle, react-resizable-panels (+7 more)
...
## Knowledge Gaps
- **304 isolated node(s):** `ACCENTS`, `MONTHS`, `DAY_NAMES`, `$schema`, `style` (+299 more)
...
- **Why does `cn()` connect `cn` to `useTranslation`, `ConfirmDialog.tsx`, `sidebar.tsx`, `utils.ts`, `ui/index.ts`, `badge.tsx`, `dropdown-menu.tsx`, `db.ts`, `input-group.tsx`, `carousel.tsx`, `instrumentation.tsx`, `breadcrumb.tsx`, `form.tsx`, `chart.tsx`, `select.tsx`, `navigation-menu.tsx`, `pagination.tsx`, `command.tsx`, `table.tsx`, `toggle-group.tsx`, `resizable.tsx`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `useTranslation()` connect `useTranslation` to `utils.ts`, `db.ts`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Button()` connect `useTranslation` to `ConfirmDialog.tsx`, `sidebar.tsx`, `ui/index.ts`, `cn`, `dropdown-menu.tsx`, `input-group.tsx`, `carousel.tsx`, `instrumentation.tsx`, `pagination.tsx`?**
...
- **Should `useTranslation` be split into smaller, more focused modules?**
  _Cohesion score 0.050561424490067106 - nodes in this community are weakly interconnected._
